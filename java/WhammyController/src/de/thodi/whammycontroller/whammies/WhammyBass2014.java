...
public class WhammyBass2014 extends Whammy {
    ...
    private static final Effect[] CLASSIC_MODE_EFFECTS = {
            ...
            new WhammyEffect("2ND UP", 4, 4 + BYPASS_OFFSET),
            new WhammyEffect("2DN DOWN", 5, 5 + BYPASS_OFFSET),
            ...
            new HarmonyEffect("4TH DOWN 3RD UP", 12, 12 + BYPASS_OFFSET),
            new HarmonyEffect("4TH DOWN 5TH UP", 13, 13 + BYPASS_OFFSET),
            new HarmonyEffect("5TH DOWN 5TH UP", 14, 14 + BYPASS_OFFSET),
            new HarmonyEffect("4TH DOWN 3RD UP", 15, 15 + BYPASS_OFFSET),
            new HarmonyEffect("5TH UP OCT UP", 16, 16 + BYPASS_OFFSET),
            new HarmonyEffect("OCT DOWN 4TH DOWN", 17, 17 + BYPASS_OFFSET),
            new HarmonyEffect("OCT DOWN OCT UP", 18, 18 + BYPASS_OFFSET),
            new HarmonyEffect("OCT UP 10TH UP", 19, 19 + BYPASS_OFFSET),
            new HarmonyEffect("OCT UP 2OCT UP", 20, 20 + BYPASS_OFFSET),
            new BypassEffect("Bypass")
    };
    private static final Effect[] CHORDS_MODE_EFFECTS = {
            new WhammyEffect("2 OCT UP", 42, 42 + BYPASS_OFFSET),
            new WhammyEffect("OCT UP", 43, 43 + BYPASS_OFFSET),
            new WhammyEffect("5TH UP", 44, 44 + BYPASS_OFFSET),
            new WhammyEffect("4TH UP", 45, 45 + BYPASS_OFFSET),
            new WhammyEffect("2ND UP", 46, 46 + BYPASS_OFFSET),
            new WhammyEffect("2DN DOWN", 47, 47 + BYPASS_OFFSET),
            new WhammyEffect("4TH DOWN", 48, 48 + BYPASS_OFFSET),
            new WhammyEffect("5TH DOWN", 49, 49 + BYPASS_OFFSET),
            new WhammyEffect("OCT DOWN", 50, 50 + BYPASS_OFFSET),
            new WhammyEffect("DIVE BOMB", 51, 51 + BYPASS_OFFSET),
            new DetuneEffect("DEEP", 52, 52 + BYPASS_OFFSET),
            new DetuneEffect("SHALLOW", 53, 53 + BYPASS_OFFSET),
            new HarmonyEffect("4TH DOWN 3RD UP", 54, 54 + BYPASS_OFFSET),
            new HarmonyEffect("4TH DOWN 5TH UP", 55, 55 + BYPASS_OFFSET),
            new HarmonyEffect("5TH DOWN 5TH UP", 56, 56 + BYPASS_OFFSET),
            new HarmonyEffect("4TH DOWN 3RD UP", 57, 57 + BYPASS_OFFSET),
            new HarmonyEffect("5TH UP OCT UP", 58, 58 + BYPASS_OFFSET),
            new HarmonyEffect("OCT DOWN 4TH DOWN", 59, 59 + BYPASS_OFFSET),
            new HarmonyEffect("OCT DOWN OCT UP", 60, 60 + BYPASS_OFFSET),
            new HarmonyEffect("OCT UP 10TH UP", 61, 61 + BYPASS_OFFSET),
            new HarmonyEffect("OCT UP 2OCT UP", 62, 62 + BYPASS_OFFSET),
            new BypassEffect("Bypass")
    };
